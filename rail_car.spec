...
a = Analysis(
    ...
    hiddenimports=['snowflake.sqlalchemy', 'snowflake-connector-python', 'webdriver_manager.firefox', 'sharepy', 'tkcalendar', 'babel.numbers', 'xlwings', 'pandas', 'bu_config', 'bu_alerts'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
